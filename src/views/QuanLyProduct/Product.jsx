...
class Product extends Component {
  ...
  successDelete(id) {
    axios.delete('http://api-organic.herokuapp.com/v1/products/' + id, 'Content-Type').then(res => {
      this.setState({
        alert: (
          <SweetAlert
            success
                            ...
                            this.state.items.map((item, key) =>
                              <tr key={item.id}>
                                ...
                                <td className="text-right">
                                  ...
                                  <Link to={"/productdetail/" + item.id} className="btn btn-simple btn-warning btn-icon edit"><i className="fa fa-edit"></i></Link>
